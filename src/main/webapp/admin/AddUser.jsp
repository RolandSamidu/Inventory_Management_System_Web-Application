							...
							<div class="card">
								<div class="card-body">
									<form action="addUserAction.jsp" method="post">
										<h3 class="mt-2 mb-3" style="color: orange;">ADD NEW USER</h3>
										...
										<div class="row g-3 mt-5">
											...
											<div class="col-md-6">
												<label class="form-label">Last Name</label> <input
													class="form-control" type="text" name="lastname" value="" required>
											</div>
											<div class="col-md-6">
										...
										<button type="submit" class="btn btn-primary mt-5" value="AddUser">Add User</button>
									</form>
								</div>
							</div>
						</div>
