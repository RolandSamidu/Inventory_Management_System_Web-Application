			...
			<header class="app-header">
				<nav class="navbar navbar-expand-lg navbar-light">
					<ul class="navbar-nav">
						...
						<li class="nav-item">
						  <a class="nav-link" href="AddItem.jsp">
						    <i class="ti ti-plus">Add Item</i>
						  </a>
						</li>
						<li class="nav-item">
						  <a class="nav-link" onClick="printPDF()">
					...
					<div class="navbar-collapse justify-content-end px-0"
						id="navbarNav">
						<form action="searchProducts.jsp" method="post" class="d-flex">
					...
					<div class="col-lg-12 d-flex align-items-stretch">
						<div class="card w-100">
							<div class="card-body p-4">
								<h5 class="card-title fw-semibold mb-4" style="color:orange;">Stock Details</h5>
								<div class="table-responsive">
									<table class="table text-nowrap mb-0 align-middle">
										<thead class="text-dark fs-4">
											<tr>
												<th class="border-bottom-0">
													<h6 class="fw-semibold mb-1" style="color:Blue;"><b>ID</b></h6>
												</th>
												<th class="border-bottom-0">
													<h6 class="fw-semibold mb-1" style="color:Blue;">Item Name</h6>
												</th>
												<th class="border-bottom-0">
													<h6 class="fw-semibold mb-1" style="color:Blue;">Quantity</h6>
												</th>
												<th class="border-bottom-0">
													<h6 class="fw-semibold mb-1" style="color:Blue;">Unit Price</h6>
												</th>
												<th class="border-bottom-0">
										...
										<tbody>
											...
											try {
												...
												Connection con = ConnectionProvider.getCon();
												Statement st = con.createStatement();
												ResultSet rs = st.executeQuery("select * from stockdetails where ITEMNAME like '%"+search+"%' or ITEMNO like '%"+search+"%' ");
												while (rs.next()) {
													z=1;
											%>
											<tr>
												...
												<td class="border-bottom-0">
													<a class="btn btn-primary edit-btn" href="EditItem.jsp?ITEMNO=<%=rs.getString(1) %>"><i class="ti ti-pencil"></i></a>
                                                    <a class="btn btn-danger delete-btn" href="deleteInventoryAction.jsp?ITEMNO=<%=rs.getString(1) %>"><i class="ti ti-trash"></i></a>
                                                    <a class="btn btn-info submit-btn" href="purchaseAction.jsp?ITEMNO=<%=rs.getString(1) %>"><i class="ti ti-shopping-cart"></i></a>
												</td>
											</tr>
