			...
			<header class="app-header">
				<nav class="navbar navbar-expand-lg navbar-light">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="AddItem.jsp">
					...
					<div class="navbar-collapse justify-content-end px-0"
						id="navbarNav">
						<form action="searchProducts.jsp" class="d-flex" method="post">
									...
									<table class="table text-nowrap mb-0 align-middle">
										...
										<tbody>
											...
											<script type="text/javascript">
                                                     alert("Order to item <%=rs.getString("ITEMNAME")%>");
											</script>
											<%
											}
											%>
											<tr>
												...
												<td class="border-bottom-0"><a
													...
													href="EditItem.jsp?ITEMNO=<%=rs.getString(1)%>"><i
														class="ti ti-pencil"></i></a> <a
													class="btn btn-danger delete-btn"
													href="deleteInventoryAction.jsp?ITEMNO=<%=rs.getString(1)%>"><i
														class="ti ti-trash"></i></a> <a
													class="btn btn-info submit-btn"
													href="CartAction.jsp?ITEMNO=<%=rs.getString(1)%>"><i
