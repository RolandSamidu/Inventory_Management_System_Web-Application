    ...
    <!--  Sidebar End -->
		...
		<div class="body-wrapper">
			...
			<header class="app-header">
				<nav class="navbar navbar-expand-lg navbar-light">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a href="AddItem.jsp" class="nav-link"> <i
								class="ti ti-plus"> Add Item</i>
						</a></li>
						<li class="nav-item"><a href="viewStockDetails.jsp" class="nav-link"> <i
								class="ti ti-article"> Stock Details</i>
						</a></li>
					</ul>
			...
			try {
				...
				ResultSet rs = st.executeQuery("select max(ITEMNO) from stockdetails ");
				while (rs.next()) {
					ITEMNO = rs.getInt(1);
					ITEMNO = ITEMNO + 1;
				}
										...
										<div class="row g-3 mt-5">
											<div class="col-md-6">
												<label for="inputText" class="form-label">Item
													...
													name="ITEMNO" value="<%out.print(ITEMNO);%>" required>
											</div>
											<div class="col-md-6">
												<label class="form-label">Item Name</label> <input
													class="form-control" type="text" name="ITEMNAME" required>
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-6">
												...
												<input class="form-control" id="inputPassword4" type="number"
													name="REORDERLEVEL" value="0" required>
											</div>
											<div class="mb-3">
												<label for="formFile" class="form-label">Image of
													Item</label> <input class="form-control" type="file" id="formFile"
