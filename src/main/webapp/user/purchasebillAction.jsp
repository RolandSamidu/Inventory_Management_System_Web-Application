...
try{
	...
	ps.executeUpdate();
	response.sendRedirect("userPurchase.jsp?msg=add");
}
catch(Exception e){
	String errorMessage = "An error occurred: " + e.getMessage();
	request.setAttribute("errorMessage", errorMessage);
	RequestDispatcher dispatcher = request.getRequestDispatcher("userPurchase.jsp");
	dispatcher.forward(request, response);

	System.out.println(e);
	response.sendRedirect("userPurchase.jsp?msg=wrong");
}
