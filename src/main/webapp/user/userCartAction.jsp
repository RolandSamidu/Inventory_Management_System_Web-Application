...
try{
	...
	if(z==0){
		PreparedStatement ps = con.prepareStatement("insert into cart(pid,product_name,quantity,price,total) values(?,?,?,?,?)");
		ps.setString(1, pid);
		...
		ps.executeUpdate();
		response.sendRedirect("userHome.jsp?msg=addToCart");
	}
	
}
catch(Exception e){
	System.out.println(e);
	response.sendRedirect("userHome.jsp?msg=wrong");
}
